    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog autoFocus as="div" className="fixed inset-0 z-50 overflow-y-auto" onClose={setOpen}>
        <div className="flex min-h-screen items-end justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block w-full transform overflow-hidden rounded-lg bg-background px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:max-w-lg sm:p-6 sm:align-middle">
              <div>
                  ...
                  {props.inputType === "slug" && (
                    <div className="mt-4">
                      ...
                      <div className="relative mt-1 rounded-md shadow-sm">
                        <input
                          value={inputString}
                          onChange={(e) => setInputString(e.currentTarget.value.toLowerCase())}
                          ref={inputValue}
                          type="text"
                          name="value"
                          id="value"
