      ...
      {index !== undefined && (
        <div className="flex items-center space-x-1 truncate">
          <button
            ...
            className={clsx(
              index <= 0 || !editable || serverAction.pending ? "cursor-not-allowed bg-gray-100 text-gray-300" : "hover:bg-gray-100 hover:text-gray-800",
              "h-4 w-4 bg-gray-50 px-0.5 py-0.5 text-gray-500 focus:outline-none"
            )}
            disabled={index <= 0 || !editable || serverAction.pending}
          >
          ...
          <button
            ...
            className={clsx(
              isLastItem() || !editable || serverAction.pending ? "cursor-not-allowed bg-gray-100 text-gray-300" : "hover:bg-gray-100 hover:text-gray-800",
              "h-4 w-4 bg-gray-50 px-0.5 py-0.5 text-gray-500 focus:outline-none"
            )}
            disabled={isLastItem() || !editable || serverAction.pending}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
              <path
                fillRule="evenodd"
