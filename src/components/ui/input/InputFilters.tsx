        ...
        >
          ...
          >
            ...
            <div className="divide-y divide-gray-200 rounded-b-md bg-white text-sm">
              {withSearch && (
                <div className="p-2">
                  <InputSearch value={searchInput} onChange={setSearchInput} placeholder={t("shared.searchAll") + "..."} />
                </div>
              )}
                        ...
                        {filter.options && filter.options.length > 0 ? (
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <Input
                              ...
                              name={filter.name}
                              autoComplete="off"
                              className="focus:border-accent-500 focus:ring-accent-500 block w-full min-w-0 flex-1 rounded-md border-gray-300 p-1 text-sm"
                              required
                              value={filter.value ?? ""}
                              onChange={(e) => {
                                updateItemByIdx(items, setItems, idx, {
