    ...
    <div className="relative">
      ...
      >
        <div className="absolute right-0 z-40 mt-2 w-64 origin-top-right divide-y divide-border overflow-hidden rounded-sm border border-border shadow-lg focus:outline-none">
          <div className="shadow-xs rounded-sm bg-background py-1" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
            ...
            {layout === "app" ? (
              <>
                ...
                <Link className="block px-4 py-2 text-sm transition duration-150 ease-in-out hover:bg-secondary" role="menuitem" href={"/new-account"}>
