    ...
    <div className="mt-2 border-t border-gray-100 p-2">
      <div className="space-y-/2">
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-5">
          ...
          <div>
            <label className="mb-1 text-xs font-medium">{t("pricing.usageBased.usageType")}</label>
            <InputSelect
              disabled={disabled}
              name="usageType"
              options={[
          ...
          <div>
            <label className="mb-1 text-xs font-medium">{t("pricing.usageBased.tiersMode")}</label>
            <InputSelect
              disabled={disabled}
              name="tiersMode"
              options={[
          ...
          <div>
            <label className="mb-1 text-xs font-medium">{t("pricing.usageBased.aggregateUsage")}</label>
            <InputSelect
              disabled={disabled}
              name="aggregateUsage"
              options={[
          ...
          <div>
            <label className="mb-1 text-xs font-medium">{t("pricing.usageBased.billingScheme")}</label>
            <InputSelect
              disabled={disabled}
              name="billingScheme"
              options={[
