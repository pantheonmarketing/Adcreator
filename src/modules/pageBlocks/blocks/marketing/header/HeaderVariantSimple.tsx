        ...
        <div className="relative pt-6">
                  ...
                  <div className="-mr-1 flex items-center space-x-2 md:hidden">
                    ...
                    {item.links.length > 0 && (
                      <button
                        ...
                        type="button"
                        className="inline-flex items-center justify-center rounded-md p-2 text-muted-foreground hover:bg-secondary hover:text-secondary-foreground focus:outline-none"
                        id="main-menu"
                        aria-haspopup="true"
                      >
          ...
          >
            <div className="absolute inset-x-0 top-0 z-40 origin-top-right transform p-2 transition md:hidden">
              <div className="overflow-visible rounded-lg border border-border bg-background shadow-xl">
