      ...
      <div className="space-y-1">
        ...
        <div>
          <button
            type="button"
            onClick={() => setSelectedProperty(null)}
            className="relative block w-full rounded-lg border-2 border-dashed border-gray-300 px-12 py-3 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
          >
            <NewFieldIcon className="mx-auto h-4 text-muted-foreground" />
