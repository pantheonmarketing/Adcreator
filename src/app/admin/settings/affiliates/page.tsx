        ...
        <div className="prose">
          <ol className="space-y-2">
            <li>
              ...
              <a href="https://www.rewardful.com/?via=saasrock" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">
                my link
              </a>{" "}
              and get a discount).
            </li>
            ...
            <li>
              Set <b>affiliates.signUpLink</b> <i>(i.e. https://saasrock.getrewardful.com/signup)</i>.
            </li>
            <li>
