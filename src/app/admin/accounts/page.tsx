...
import { addTenantUser, createTenant, tenantSlugAlreadyExists } from "@/modules/accounts/services/TenantService";
...
const loader = async ({ searchParams }: IServerComponentsProps) => {
  ...
  const { items, pagination } = await db.tenant.getAllWithPagination({ filters, pagination: currentPagination });
