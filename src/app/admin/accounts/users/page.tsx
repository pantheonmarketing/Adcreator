...
import { getBooleanFilter, getCurrentPagination, getNullableStringFilter, getStringFilter } from "@/lib/helpers/PaginationHelper";
...
const loader = async ({ searchParams }: IServerComponentsProps) => {
  ...
  const { items, pagination } = await db.user.getAllWithPagination({ filters, pagination: currentPagination });
