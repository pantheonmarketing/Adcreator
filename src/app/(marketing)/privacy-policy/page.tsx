          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div className="sm:align-center space-y-4 sm:flex sm:flex-col">
              <div className="prose mx-auto text-gray-500">
                ...
                <p>
                  Your privacy is important to us. It is RockStack&#39; policy to respect your privacy and comply with any applicable law and regulation
                  regarding any personal information we may collect about you, including across our website,{" "}
                  <a className="text-black dark:text-white" href="https://rockstack.dev">
                    https://rockstack.dev
                  </a>
